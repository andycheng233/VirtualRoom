...
**CPSC 3800 (Computer Vision) Final Project**
...
├── je_courtyard_images/          # Sample: Jonathan Edwards images (18 JPEGs)
├── becton_rbg/                   # Sample: Becton Center images (18 PNGs)
│
...
# Examples:
python custom_pano_stitcher.py ./je_courtyard_images -o je_custom_pano.png
python custom_pano_stitcher.py ./becton_rbg -o becton_custom_pano.png
```
...
1. **Capture images** by rotating camera around a fixed point:
   ```bash
...
| Becton Center | 3 MB | 41.312466°N, -72.9251862°W |
...
CPSC 3800 Final Project - Yale University
